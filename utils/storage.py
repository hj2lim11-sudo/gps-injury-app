...
KR_COLS = {
    ...
    "jersey_no":            "등번호",
    "player_name":          "이름",
    "total_distance_km":    "뛴 거리(km)",
    "distance_per_min":     "분당 뛴 거리(m/min)",
    "max_speed":            "최고 속도(km/h)",
    "hsr_distance":         "HSR 거리(m)",
    "hsr_count":            "HSR 횟수",
    "sprint_distance":      "Sprint 거리(m)",
    "sprint_count":         "Sprint 횟수",
    "high_acc_count":       "강한 가속 횟수",
    "high_acc_distance":    "강한 가속 거리(m)",
    "high_dec_count":       "강한 감속 횟수",
    "high_dec_distance":    "강한 감속 거리(m)",
    "max_acc":              "최대 가속(m/s²)",
    "max_dec":              "최대 감속(m/s²)",
    "acd_load":             "ACD Load",
    "zone1_distance":       "속도1구간 거리(km)",
    "zone2_distance":       "속도2구간 거리(km)",
    "zone3_distance":       "속도3구간 거리(km)",
    "zone4_distance":       "속도4구간 거리(km)",
    "zone5_distance":       "속도5구간 거리(km)",
    "acr_distance":         "뛴 거리(ACR)",
    "acr_hsr":              "HSR 거리(ACR)",
    "acr_sprint":           "Sprint 거리(ACR)",
    "acr_acd_load":         "ACD Load(ACR)",
}
